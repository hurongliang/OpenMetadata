...
const proportionMetrics = {
  information: [
    ...
    { label: 'Accuracy Proportion', dataKey: 'accuracyProportion' },
    { label: 'Consistency Proportion', dataKey: 'consistencyProportion' },
    ...
    expect(result.proportionMetrics.data).toEqual([
      {
        ...
        accuracyProportion: 50,
        consistencyProportion: 50,
        nullProportion: 5,
        uniqueProportion: 45,
      },
    ]);
