...
def get_default_metrics(
    ...
    return [
        ...
        Metrics.ACCURACY_ADDRESS_COUNT.value,
        Metrics.ACCURACY_BANKCARDNUMBER_COUNT.value,
        Metrics.ACCURACY_CHINESENAME_COUNT.value,
        Metrics.ACCURACY_DATE_COUNT.value,
        Metrics.ACCURACY_EMAIL_COUNT.value,
        Metrics.ACCURACY_IDNUMBER_COUNT.value,
        Metrics.ACCURACY_IPADDRESS_COUNT.value,
        Metrics.ACCURACY_PHONE_COUNT.value,
