...
class AccuracyDateCount(StaticMetric):
    ...
    expression = r"^(19|20)\d{2}[-/年](0[1-9]|1[012])[-/月](0[1-9]|[12][0-9]|3[01])$|^19\d{2}(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])$|^19\d{2}年(0[1-9]|1[012])月(0[1-9]|[12][0-9]|3[01])日.*$"

    @classmethod
    def name(cls):
        return MetricType.accuracyDateCount.value
    ...
    def df_fn(self, dfs):
        ...
        raise TypeError(
            f"Don't know how to process type {self.col.type} when computing Date Match Count"
        )
